...
var matchVersion = function matchVersion(versions, range) {
  var matches = versions.reduce(function (acc, curr) {
    if (_semver.default.satisfies(curr, range)) {
      return (0, _toConsumableArray2.default)(acc).concat([curr]);
    }
...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(module, range, registry) {
...
var getPackageVersions =
/*#__PURE__*/
function () {
  var _ref2 = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(module, range, alternateRegistry) {
